...
grouped_messages_sf <- location_ids_spatial %>%
  left_join(grouped_messages %>%
  left_join(location_ids,by=c("lon_bin","lat_bin")),by="location_id")
  left_join(location_ids_spatial,by="location_id")
...
map_figure_rel <-   grouped_messages_sf %>%
  ...
  geom_sf(aes(fill = fraction_at_risk_fishing_kW_hours),color=NA,lwd=0) +
...
ggsave(here::here("output_figures/figure_3.png"),map_figure_rel,width=6,height=7.5,device="png",dpi=300)
```
...
ggsave(here::here("/output_figures/figure_4.png"),port_map_figure_rel,width=6,height=7.5,device="png",dpi=300)      
```
...
ggsave(here::here("output_figures/figure_s3.png"),cv_performance_fig,width=7.5,height=5,device="png",dpi=300)
```
