...
write_csv(vessels_fig_data_summary_combined,here::here("interim_data/figure_2_data.csv"))
...
ggsave(here::here("output_figures/figure_s1.png"),ilo_indicator_fig,width=7.5,height=7.5,device="png",dpi=1200)
```
...
ggsave(here::here("output_figures/figure_s2.png"),training_dataset_fig,width=7.5,height=4.5,device="png",dpi=1200)
```
...
ggsave(here::here("output_figures/figure_s3.png"),cv_performance_fig,width=7.5,height=5,device="png",dpi=1200)
```
...
ggsave(here::here("output_figures/figure_s4.png"),class_fig,width=7.5,height=3.5,device="png",dpi=1200)
```
...
ggsave(here::here("output_figures/figure_s5.png"),importance_fig,width=7.5,height=5,device="png",dpi=1200)
```
...
ggsave(here::here("output_figures/figure_s6.png"),robustness_cv_fig,width=7.5,height=5,device="png",dpi=1200)
...
ggsave(here::here("output_figures/figure_s7.png"),robustness_final_fig,width=7.5,height=7.5,device="png",dpi=1200)
